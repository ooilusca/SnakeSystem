object frmCadPadrao: TfrmCadPadrao
  ...
  object FDCadPadrao: TFDQuery
    Connection = Dados.FDConexao
    Transaction = FDTCadPadrao
    UpdateObject = FDUCadPadrao
    SQL.Strings = (
      'SELECT * FROM CLIENTE')
    Left = 376
    Top = 16
  end
  object FDUCadPadrao: TFDUpdateSQL
    Connection = Dados.FDConexao
    Left = 480
    Top = 16
  end
  object FDTCadPadrao: TFDTransaction
    Connection = Dados.FDConexao
    Left = 448
    Top = 16
  end
  object dsCadPadrao: TDataSource
    DataSet = FDCadPadrao
    Left = 413
    Top = 16
  end
